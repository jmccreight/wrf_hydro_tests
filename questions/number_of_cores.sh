...
echo -e "\e[7;49;32mnumber_of_cores.sh: Running candidate binary with $nCoresTest cores\e[0m"
...
echo
echo -e "\e[0;49;32m-----------------------------------\e[0m"
echo -e "\e[7;49;32mQuestion: Are restarts unchanged with the number of cores used?\e[0m"

#compare restart files
python3 $answerKeyDir/compare_restarts.py $domainRunDir/run.candidate $domainRunDir/run.candidate.ncores_test \
    || { echo -e "\e[5;49;31mNumber of  cores test: restarts comparison failed.\e[0m"; exit 1; }
echo -e "\e[5;49;32mNumber of cores test: restart comparison successful!\e[0m"    
