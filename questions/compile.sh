...
echo -e "\e[7;49;32mcompile.sh: compiling candidate fork.\e[0m"    
...
$toolboxDir/config_compile_gnu_NoahMP.sh || \
    { echo -e "\e[5;49;31mCandidate fork: compilation failed under GNU.\e[0m"; exit 1; }
echo -e "\e[5;49;32mCandidate fork: successful compilation under GNU!\e[0m"
